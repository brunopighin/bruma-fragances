...
const CATEGORIAS = [
  { id: "masculinos",  nombre: "Masculinos" },
  { id: "femeninos",   nombre: "Femeninos" },
  { id: "unisex",      nombre: "Unisex" },
  { id: "importados",  nombre: "Importados" },
  { id: "arabe",       nombre: "Árabe" },
  { id: "nicho",       nombre: "Nicho" },
  { id: "sets",        nombre: "Sets y Regalos" },
];
...
const tabTitles = { productos: "Productos", imagenes: "Imágenes de secciones", config: "Configuración" };
